...
SECRET_KEY = 'django-insecure-$@wjka$9au5#-1f9!o3sn3ug^d81h1m-c@el6eryhu+jd)n+7)'
...
#DEFAULT_FROM_EMAIL = 'dimas00095@yandex.ru'
...
TEMPLATES = [
    {
        ...
        'DIRS':
            [os.path.join(BASE_DIR, 'templates')],  # Убрано согласно документации по allauth
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
EMAIL_HOST_USER = 'dmitrushatest'  # ваше имя пользователя, например, если ваша почта user@yandex.ru, то сюда надо
# писать user, иными словами, это всё то что идёт до собаки
EMAIL_HOST_PASSWORD = 'htcwoffh'  # пароль от почты
